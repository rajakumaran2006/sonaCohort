                          ...
                          {exams.map((exam) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell className="text-center py-4">
                                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded uppercase text-xs font-medium ${statusColor}`}>
                                    {status}
                                  </span>
                                </TableCell>
                                <TableCell className="text-center py-4">
                                  <div className="w-full max-w-[100px] mx-auto">
                                    ...
                                    <div className="w-full bg-gray-100 rounded-full h-1.5">
                                      <div
                                        className={`h-1.5 rounded-full ${progress === 100 ? 'bg-green-500' :
