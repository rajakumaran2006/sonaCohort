                          ...
                          {stats.additionalClassesByYear.map((item, index) => {
                            ...
                            return (
                              <div key={index} className="flex-1 flex flex-col items-center justify-end group">
                                 <div className="text-sm font-black text-gray-900 mb-2 transition-opacity">{item.count}</div>
                                 <div 
                                    className="w-12 bg-purple-500 rounded-t-xl transition-all duration-500 cursor-pointer shadow-lg hover:shadow-purple-500/20 hover:-translate-y-1" 
