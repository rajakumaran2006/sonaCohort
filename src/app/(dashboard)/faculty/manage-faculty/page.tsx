...
import { Search, Plus, User, Mail, School, BookOpen, Loader2 } from 'lucide-react'
                          ...
                          <td className="px-6 py-4">
                             <div className="flex flex-wrap gap-2">
                               ...
                               {(f.subjects || []).map((s: string, idx: number) => (
                                 <span key={idx} className="inline-flex items-center px-2.5 py-1 rounded-md bg-green-50 text-green-700 text-xs font-medium border border-green-100">
                                   {s}
                                 </span>
                               ))}
