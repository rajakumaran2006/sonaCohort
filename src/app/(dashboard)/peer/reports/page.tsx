...
function PeerReportsContent() {
  ...
  const [reportData, setReportData] = useState<PeerTutorReportData | null>(null)
  ...
  const loadPeerTutorData = async () => {
    ...
    try {
      ...
      if (tutorInfo) {
        ...
        // Get report data for this peer tutor
        const report = await ReportService.getPeerTutorReportData(tutorInfo.id)
        ...
        <header className="bg-white shadow-sm border-b border-gray-200">
          <div className="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-semibold text-gray-900 ml-2 lg:ml-0">My Reports</h1>
            </div>
            <button
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {loading ? (
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-5 w-0 flex-1">
                          <dl>
                            ...
                            <dd className="text-lg font-medium text-gray-900">{reportData.subjects.length}</dd>
                          </dl>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-white shadow rounded-lg">
                  <div className="px-6 py-4 border-b border-gray-200">
                    <h3 className="text-lg font-medium text-gray-900">
                      My Subjects ({reportData.subjects.length})
                    </h3>
                  </div>
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {reportData.subjects.map((subject) => {
                              const completionRate = subject.total_classes > 0 
                                ? Math.round((subject.completed_classes / subject.total_classes) * 100)
                                : 0
                              
                              return (
                                <tr key={subject.class_id} className="hover:bg-gray-50">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">There was an error loading your report data. Please try again.</p>
              </div>
            )}
          </div>
        </main>
