              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredLogs.map((cls) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`absolute top-0 right-0 w-24 h-24 rounded-bl-[4rem] -mr-6 -mt-6 transition-transform group-hover:scale-110 ${isCompleted
                      ...
                      <div className="relative z-10">
                        <div className="flex justify-between items-start mb-4">
                          <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold text-sm ${isCompleted
                            ? (isScheduled ? 'bg-emerald-500' : 'bg-purple-500')
                            : 'bg-orange-400'
                            }`}>
                            {dateObj.getDate()}
                          </div>
                          <span className={`text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider ${isCompleted
