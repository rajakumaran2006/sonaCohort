              ...
              <table className="w-full border-collapse border border-gray-800 min-w-full">
                <thead>
                  <tr>
                    ...
                    <th className="border border-gray-800 px-4 py-3 w-24 text-center text-sm font-bold text-gray-900 bg-transparent">HOUR</th>
                ...
                <tbody>
                  {subject.classes.map((cls, idx) => (
                    <tr key={cls.id}>
                      ...
                      <td className="border border-gray-800 px-4 py-3 text-center text-sm text-gray-900 h-12">{formatDate(cls.date)}</td>
                      <td className="border border-gray-800 px-4 py-3 text-center text-sm text-gray-900 h-12 font-medium">
                        {cls.is_additional ? 'A' : '1'}
                      </td>
