        ...
        <div className="px-8 py-5 border-t border-gray-100 bg-white shrink-0">
          <div className="flex items-center justify-between">
            <div className="text-sm">
                ...
                <span className="text-blue-600 font-bold bg-gray-50 px-2 py-0.5 rounded-md ml-1">
                  {selectedStudents.size} TUTOR{selectedStudents.size !== 1 && 'S'}
                </span>
            </div>
            <div className="flex gap-3">
              ...
              >
                ...
                {!isAssigning && selectedStudents.size > 0 && <Check className="w-4 h-4" />}
