...
export default function FeedbackAnalyticsPage({ form }: FeedbackAnalyticsPageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Header Stats - Simplified Cards Matching Reference */}
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-500 text-sm font-medium mb-1">Responses</p>
        ...
        <Card className="border border-gray-200 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-500 text-sm font-medium mb-1">Avg. Completion</p>
                <p className="text-2xl font-bold text-gray-900">
        ...
        <Card className="border border-gray-200 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-500 text-sm font-medium mb-1">Satisfaction</p>
                <p className={`text-2xl font-bold ${analytics.totalResponses > 0 ? getSatisfactionColor(analytics.satisfactionScore) : 'text-gray-900'}`}>
        ...
        <Card className="border border-gray-200 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-500 text-sm font-medium mb-1">Delta Score</p>
                <p className={`text-2xl font-bold ${analytics.totalResponses > 0 ? getDeltaColor(analytics.satisfactionDelta) : 'text-gray-900'}`}>
